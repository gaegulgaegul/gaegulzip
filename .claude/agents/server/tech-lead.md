...
### 7. server-brief.md 작성
`docs/[product]/[feature]/server-brief.md`에 구현 계획 문서 작성 (상세 포맷은 아래 참조)
...
`docs/[product]/[feature]/server-brief.md` 파일을 다음 구조로 작성:
...
`docs/[product]/[feature]/server-brief.md` 작성 및 사용자 승인 완료 후:
