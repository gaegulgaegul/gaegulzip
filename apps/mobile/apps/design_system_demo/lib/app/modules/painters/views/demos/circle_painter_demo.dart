...
/// SketchCirclePainter 데모
///
/// fillColor, borderColor, roughness, segments 조절
class CirclePainterDemo extends StatefulWidget {
  const CirclePainterDemo({super.key});

  @override
  State<CirclePainterDemo> createState() => _CirclePainterDemoState();
}

class _CirclePainterDemoState extends State<CirclePainterDemo> {
  // 미리 정의된 색상 목록
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSlider(
            ...
            8.0,
            32.0,
            (value) => setState(() => _segments = value.toInt()),
          ),
          const SizedBox(height: SketchDesignTokens.spacingLg),
